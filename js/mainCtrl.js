angular.module('chatroom').controller('mainCtrl', function($scope, messageService){
  ...
  $scope.getMessages = function() {
    messageService.getMessages().then(function(result) { //messageService is getting the promise from the service, .then method to use the data
  ...
  $scope.postMessage = function(message) {
    messageService.postMessages(message).then(function(result) {
      console.log(result)
    })
  }
